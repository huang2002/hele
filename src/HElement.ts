...
export const elementMap = new Map<Component, HElement>();
...
export class HElement {
    ...
    constructor(
        public readonly type: string | ComponentGetter,
        props: Props
    ) {
        this.props = (typeof type !== 'string' && type.prototype instanceof Component) ?
            Object.assign({}, (type as ComponentConstructor).defaultProps, props) :
            props;
    }
    ...
    toNode(): Node | Node[] {
        ...
        if (typeof type === 'string') {
            ...
            const { element, component } = applyPropsToComponent(props, type),
